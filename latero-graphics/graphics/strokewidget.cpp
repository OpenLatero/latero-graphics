...
public:
	...
	{
		append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL,adj_, 1, units::percent, "stroke intensity"));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL,adj_, 1, units::mm, "stroke width"));
