...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL,adj_, 1, "stroke intensity", "%"));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL,adj_, 1, "stroke width", "mm"));
