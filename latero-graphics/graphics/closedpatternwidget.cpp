...
public:
	...
	{
		append(*Gtk::make_managed<latero::graphics::gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL,adj_, 1, "gap", "mm"));
...
public:
	...
	{
		append(*Gtk::make_managed<latero::graphics::gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 1, "edge size", "mm"));
