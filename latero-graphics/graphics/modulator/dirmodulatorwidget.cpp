...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, "direction tolerance", adj_, 0, units::degree));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, "direction transition rate", adj_, 0, units::degree));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, "velocity tolerance", adj_, 0, units::mm_per_sec));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL,"velocity transition rate", adj_, 0, units::mm_per_sec));
