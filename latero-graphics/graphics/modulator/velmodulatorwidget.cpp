...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, "lower limit", adj_, 0, units::mm_per_sec));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, "transition rate", adj_, 0, units::mm_per_sec));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, "delayed onset", adj_, 0, units::ms));
