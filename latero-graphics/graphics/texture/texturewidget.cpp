...
{
	auto widget = Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::VERTICAL, adj_,0, units::percent);
	append(*widget);
	widget->set_hexpand();
...
public:
	...
	{
		auto widget = Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, adj_,0, units::degree);
		append(*widget);
		widget->set_vexpand();
...
public:
	...
	{
		auto widget = Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 1, units::mm_per_sec);
		append(*widget);
		widget->set_vexpand();
