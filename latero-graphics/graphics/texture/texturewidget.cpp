...
{
	auto widget = Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::VERTICAL, adj_,0, gtk::name_none, units::percent);
	append(*widget);
	widget->set_hexpand();
...
public:
	...
	{
		auto widget = Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_,0, gtk::name_none, units::degree);
		append(*widget);
		widget->set_vexpand();
...
public:
	...
	{
		auto widget = Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 1, gtk::name_none, units::mm_per_sec);
		append(*widget);
		widget->set_vexpand();
