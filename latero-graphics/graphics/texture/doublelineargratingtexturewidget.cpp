...
public:
	...
	{
		append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 0, "orientation", units::degree));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 1, "primary ridge size", units::mm));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 1,"secondary scale", gtk::units_none));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 1, "primary gap size", units::mm));
...
public:
        ...
        peer_(peer)
	{
		...
		set_child(*box);
		box->append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::VERTICAL, adj0_,0, gtk::name_none, units::percent));
		box->append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::VERTICAL, adj1_,0, gtk::name_none, units::percent));
