...
public:
	...
	{
		append(*Gtk::make_managed<latero::graphics::gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 1, "rounding offset", "mm"));
...
public:
	...
	{
		auto widget = Gtk::make_managed<latero::graphics::gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL,adj_, 1, "blending size", "mm");
