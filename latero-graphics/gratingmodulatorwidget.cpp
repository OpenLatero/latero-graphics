...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 1));
...
public:
	...
	{
		append(*Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL,adj_,0,peer->GetUnits()));
		adj_->signal_value_changed().connect(
