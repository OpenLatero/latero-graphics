...
public:
	...
	{
		gtk::HVNumWidget *wWidget = Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL, wRelAdj_, 0, "width",units::percent);
		...
		gtk::HVNumWidget *hWidget = Gtk::make_managed<gtk::HVNumWidget>(Gtk::Orientation::HORIZONTAL,hRelAdj_,0, "height",units::percent);
