	...
	yAdj_(Gtk::Adjustment::create(init.y, ylim_min, ylim_max))
{
	if (showSliders)
	{
		auto xWidget = Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, xAdj_, 3, gtk::name_none, "mm");
		auto yWidget = Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, yAdj_, 3, gtk::name_none, "mm");
