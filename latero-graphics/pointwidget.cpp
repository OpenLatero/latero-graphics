	...
	yAdj_(Gtk::Adjustment::create(init.y, ylim_min, ylim_max))
{
	if (showSliders)
	{
		auto xWidget = Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, xAdj_, 3, "mm", gtk::name_none);
		auto yWidget = Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, yAdj_, 3, "mm", gtk::name_none);
