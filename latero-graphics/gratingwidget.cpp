...
void GratingRhythmWidget::AppendCycle(double value)
{
	...
	auto widget = Gtk::make_managed<latero::graphics::gtk::NumWidget>(Gtk::Orientation::VERTICAL, adj,0,gtk::name_none,gtk::units_none);
...
{
	append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 2, "gap size", peer->GetUnits()));
...
{
	append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 2, "ridge size", peer->GetUnits()));
...
{
	gtk::NumWidget *widget = Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, distAdj_, 0, "velocity", peer->GetUnits() + units::per_sec);
...
{
	append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 0, "amplitude", units::percent));
