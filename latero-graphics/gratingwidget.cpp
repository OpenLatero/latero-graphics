...
{
	append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 2, peer->GetUnits(), "gap size"));
...
{
	append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 2, peer->GetUnits(), "ridge size"));
...
{
	gtk::NumWidget *widget = Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, distAdj_, 0, peer->GetUnits() + units::per_sec, "velocity");
...
{
	append(*Gtk::make_managed<gtk::NumWidget>(Gtk::Orientation::HORIZONTAL, adj_, 0, units::percent, "amplitude"));
